...
<div>
  <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select your country (From)</label>
  <Select
    id="countries"
...
<div>
  <label htmlFor="countries" className="block mt-2 mb-2 text-sm font-medium text-gray-900 dark:text-white">To</label>
...
<label htmlFor="countries" className="block mt-2 text-sm font-medium text-gray-900 dark:text-white">Amount</label>
...
<div className='flex justify-between mb-2 mt-2'>
  ...
  <div className='font-bold text-sm text-gray-700'><span >70</span> USD</div>
